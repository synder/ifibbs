...
const question = require('./ifibbs_indices/question');
const tags = require('./ifibbs_indices/tags');
const answer = require('./ifibbs_indices/answer');
const article = require('./ifibbs_indices/article');
const subject = require('./ifibbs_indices/subject');
